namespace Turbo.plugins.patrick.skills.definitions.party
{
    ...
    public class BuffTimeLeftOnHeroClass : AbstractDefinition
    {
        ...
        public override string attributes
        {
            get
            {
                ...
                return $"[ {assembledHeroName}{assembledBuffName}{assembledRange}TimeLeft {Operator} {TimeLeftInMs}ms, IconIndex: {IconIndex} ]";
            }
        }
